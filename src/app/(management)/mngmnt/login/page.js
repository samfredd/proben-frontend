...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    setLoading(true);
    const res = await login(email, password, 'management');
    ...
    >
      <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
        <div className="text-left">
          <h2 className="text-4xl font-black text-navy-900 tracking-tight mb-3">Admin Sign In</h2>
          <p className="text-gray-500 font-medium">Access the Proben administrative control panel.</p>
        </div>
